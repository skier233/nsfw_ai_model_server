...
class AITaggingModel(AIModel):
    ...
    async def worker_function(self, data):
        try:
            ...
            # Cast to model's expected precision.  Default is half for tagging
            # models; explicit model_precision (e.g. "float32" for TensorRT)
            # overrides.  This is cheap when the dtype already matches.
